    ...
    const {currentDay,data} = this.props
        ...
        <div>
          ...
          <Row type="flex" justify="center" >
            ...
            <Col xs={24} sm={12} md={6} lg={6} xl={5} className={styles.dayContainer}>
            ...
            <Col xs={24} sm={12} md={7} lg={7} xl={5} className={styles.dayContainer}>
            ...
            <Col xs={24} sm={24} md={7} lg={7} xl={5} className={styles.dayContainerLast}>
