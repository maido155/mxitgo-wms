...
import { Drawer, Row, Col, Button, Icon, Divider, Form } from 'antd';
import { isMobile } from 'react-device-detect';
import DrawerBuy from './drawerBuy';


const AssignmentOutComming = Form.create()(
    class extends PureComponent {
        ...
        render() {
            let { dataOutcommingsByEntry, boxesRequired, assignedBox, currentOutcomming, setVisibleBuy, visibleBuy, onCloseVisibleBuy } = this.props;
            ...
            return (
                ...
                >
                    <Row type="flex" justify="center">
                        ...
                        <Col xs={24} sm={12} md={8} lg={7} xl={5} style={{ textAlign: "center" }}>
                            {this.boxesRequired(boxesRequired, assignedBox)}
                        </Col>
                        <Col xs={24} sm={8} md={7} lg={6} xl={3} style={{ textAlign: "center" }}>
                            <Button
                        ...
                        <Col xs={24} sm={8} md={7} lg={6} xl={3} style={{ textAlign: "center" }}>
                            <Button disabled={this.state.buttonAssign} type="primary" icon="shopping" onClick={ () => { setVisibleBuy()}}><FormattedMessage id="outComming.button.assignment-outcomming-sale-floor" /></Button>
                        </Col>
                        <DrawerBuy 
                            visibleBuy={visibleBuy} 
                            onCloseVisibleBuy={onCloseVisibleBuy} 
...
export default AssignmentOutComming;