  ...
  render() {
    ...
    let columns = [
      ...
      },
      {
        ...
        render: (text, record) => (
        <Text type={this.dates(record.products[2].planned,record.products[2].confirmed)} onClick={() => { this.props.showModalProduct(record,record.products[2].product)}} className={Styles.producto}>{record.products[0].planned}/{record.products[0].confirmed}</Text>
        )
      },
      {
        ...
        render: (text, record) => (
                <Text type={this.dates(record.products[3].planned,record.products[3].confirmed)} onClick={() => { this.props.showModalProduct(record,record.products[3].product)}} className={Styles.producto}>{record.products[1].planned}/{record.products[1].confirmed}</Text>
        )
      },
      {
        ...
        width: isMobile ? 130 : 100,
        render: (text, record) => (
                <Text type={this.dates(record.products[1].planned,record.products[1].confirmed)} onClick={() => { this.props.showModalProduct(record,record.products[1].product)}} className={Styles.producto}>{record.products[2].planned}/{record.products[2].confirmed}</Text>
        )
      },
      {
        ...
        render: (text, record) => (
                <Text type={this.dates(record.products[4].planned,record.products[4].confirmed)} onClick={() => { this.props.showModalProduct(record,record.products[4].product)}} className={Styles.producto}>{record.products[3].planned}/{record.products[3].confirmed}</Text>
        )
      },
      {
        ...
        width: isMobile ? 120 : 100,
        render: (text, record) => (
          <Text type={this.dates(record.products[0].planned,record.products[0].confirmed)} onClick={() => { this.props.showModalProduct(record,record.products[0].product)}} className={Styles.producto}>{record.products[4].planned}/{record.products[4].confirmed}</Text>
        )
      },
      {
          ...
          <a>
            {record.status == "NEW"
              ...
              : record.status == "CONFIRMED"
                ?
                  <a>
                    <Button type="link" onClick={() => { this.props.showDrawerShipping("EDIT",record) }} disabled={true}>
                      {isMobile
                        ? <Icon type="edit" />
                        : <a><Icon type="edit" /> <FormattedMessage id="shipping.label.table-shipping.edit" /></a>
                      }
                ...
                :
                  <a>
                    ...
                    <Divider type="vertical"/>
                    <Button type="link" onClick={this.props.showConfirmation("CONF", record)} disabled={true}>
                      {isMobile
                        ? <Icon type="check" />
                        : <a><Icon type="check" /> <FormattedMessage id="shipping.label.table-shipping.confirm"/></a>
                      }
