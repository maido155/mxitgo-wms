    ...
    render(){
        ...
        return(
            ...
            >
                <Form {...formItemLayout}>
                    <Row>
                        <Col xs={1} sm={0} md={0} lg={0} xl={2}></Col>
                        <Col xs={7} sm={17} md={17} lg={8} xl={7}>
                            <Form.Item label={formatMessage({id: "general.calendar.week"})}/>
                        </Col>
                        <Col xs={16} sm={24} md={24} lg={16} xl={14}>
                    ...
                    <Divider/>
                    <Row>
                        <Col xs={8} sm={0} md={0} lg={8} xl={9}></Col>
                        <Col xs={8} sm={0} md={0} lg={8} xl={7} style={{paddingBottom: ".7rem"}}>
                    ...
                    <Row>
                        ...
                        <Col xs={8} sm={12} md={12} lg={8} xl={7}>
                            <InputNumber/>
                        </Col>
                        <Col xs={8} sm={12} md={12} lg={8} xl={7}>
                            <InputNumber/>
                    ...
                    <Row>
                        ...
                        <Col xs={8} sm={12} md={12} lg={8} xl={7} style={{paddingTop: ".5rem"}}>
                            <label style={{ marginLeft:"35%"}}>0</label>
                        </Col>
                        <Col xs={8} sm={12} md={12} lg={8} xl={7} style={{paddingTop: ".5rem"}}>
                            <label style={{ marginLeft:"35%"}}>0</label>
                        </Col>
