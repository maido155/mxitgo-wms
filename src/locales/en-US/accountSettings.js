export default {
    'accountSettings.mode.message.account': 'Account',
    'accountSettings.label.upload-image': 'Upload image',
    'accountSettings.button.save': 'Save',
    'accountSettings.mode.message.save': 'Data updated succesfully',
